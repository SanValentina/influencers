...
class InfluencersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create influencer" do
    assert_difference('Influencer.count') do
      post influencers_url, params: { influencer: { engagement: @influencer.engagement, followers: @influencer.followers, name: @influencer.name, social_media: @influencer.social_media } }
    end
  ...
  test "should update influencer" do
    patch influencer_url(@influencer), params: { influencer: { engagement: @influencer.engagement, followers: @influencer.followers, name: @influencer.name, social_media: @influencer.social_media } }
